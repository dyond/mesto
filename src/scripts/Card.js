class Card { 
  constructor(data, templateSelector, handleCardClick) { 
    ...
    this._handleCardClick = handleCardClick; // bind handleCardClick to _handleCardClick
  ...
  _setEventListeners() { 
    this._cardImage.addEventListener("click", () => { 
      this._handleCardClick(this._name, this._link); // pass _name and _link to _handleCardClick
    }); 
