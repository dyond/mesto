...
let buttonLike = document.querySelectorAll('.card__button')

// buttonLike.addEventListener('click',function(e){
//   let buttonLike = document.querySelector('.card__button')
//   let imageLike = document.getElementById('card__button-like')
