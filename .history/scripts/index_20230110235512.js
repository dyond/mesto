...
function displayCard({ name, link }){
  ...
  placeElement.querySelector('.card__button').addEventListener('click', function(){

    if (placeElement.querySelector('img').getAttribute('src') === 'images/vector_3.svg'){
      placeElement.querySelector('img').src = 'images/vector_4.svg'
    }else{
      placeElement.querySelector('img').src = 'images/vector_3.svg'
    }
  })
