...
function displayCard({ name, link }){
  ...
  co cardImage = placeElement.querySelector(".card__image")
  co cardTitle = placeElement.querySelector(".card__title")
  ...
  cardImage.addEventListener('click', function(){
    ...
    co cardImageSrc = cardImage.src
    co cardTitleSrc = cardTitle.textContent
