...
function openPopup(i){
  ...
  if(i === 1) {
   ...
   if (popup[i].classList.contains('popup_opened')) {
    popup[i].classList.remove('popup_opened');
    setTimeout(function () {
      popup[i].classList.remove('visuallyhidden');
    }, 20);
  } else {
    popup[i].classList.add('visuallyhidden');    
    popup[i].addEventListener('transitionend', function(e) {
