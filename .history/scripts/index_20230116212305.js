...
function displayCard({ name, link }){
  ...
  let popupCaption = document.querySelector('.popup__caption').textContent
  ...
  cardImage.addEventListener('click', function(){
    ...
    body.style.overflow = 'hidden'
    // Получаем значание картинки и названия месьа
    let cardImageSrc = cardImage.src
    let cardTitleSrc = cardTitle.textContent

    popupImage = cardImageSrc
    popupCaption = cardTitleSrc
    console.log(popupImage, popupCaption)
  })
