...
const cardTempla = document.querySelector("#card-template").content;
...
function display() {
  createCard.forEach(renderCard);
}

function renderCard({ name, link }) {
  const placeElement = cardTempla.querySelector(".card").cloneNode(true);
