...
formElement.forEach.call(formElement,function(el, i){
  el.addEventListener('submit', function(evt){
    ...
    if ( i === 0 ){
      ...
      console.log(placeInput, <ul class="list-inline">
...
function addCard({name , link}){
  ...
  // console.log(cardTemplateClone.querySelector('.card__title').textContent)
  cardTemplateClone.querySelector('.card__image').src = link
  // console.log(cardTemplateClone.querySelector('.card__image').src)
