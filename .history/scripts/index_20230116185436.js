...
let imageClose = document.querySelector('.popup__image_close')
let imageBlock = document.querySelector('.popup__image-block_opened')

imageClose.addEventListener('click', function(){
  imageClose.classList.remove('popup__image-block_opened')
})
